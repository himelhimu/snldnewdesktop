...
package com.mpower.clientcollection.logic;
...
//import com.mpower.clientcollection.views.ClientCollectionView;
...
public class FormController {
    ...
    private boolean groupIsFieldList(FormIndex index) {
        ...
        return (gd.getAppearanceAttr() != null);
    }
    ...
    private int answerQuestion(IAnswerData data) {
        return mFormEntryController.answerQuestion(data,false);
    }
    ...
    public int answerQuestion(FormIndex index, IAnswerData data) {
        return mFormEntryController.answerQuestion(index, data,false);
    }
    ...
    public boolean saveAnswer(FormIndex index, IAnswerData data) {
        return mFormEntryController.saveAnswer(index, data,false);
    }
     ...
     * @return true if saved successfully, false otherwise.
     */
    public boolean saveAnswer(IAnswerData data,boolean b) {
        return mFormEntryController.saveAnswer(data,b);
    }
        ...
        if (getEvent() != FormEntryController.EVENT_BEGINNING_OF_FORM) {
            ...
            if ( getEvent() == FormEntryController.EVENT_GROUP ) {
                ...
                if (element instanceof GroupDef) {
                	...
                	/*if ( ClientCollectionView.FIELD_LIST.equalsIgnoreCase(gd.getAppearanceAttr()) ) {
                		...
                		if ( fclist.length > 1) {
                			...
                			if ( pd.getChildren().size() == 1 &&
                				 ClientCollectionView.FIELD_LIST.equalsIgnoreCase(pd.getAppearanceAttr()) ) {
        ...
        if (element instanceof GroupDef) {
            ...
            if ( gd.getChildren().size() == 1 && getEvent(idxChild) == FormEntryController.EVENT_GROUP ) {
                ...
                if (nestedElement instanceof GroupDef) {
                    ...
                    /*if ( ClientCollectionView.FIELD_LIST.equalsIgnoreCase(nestedGd.getAppearanceAttr()) ) {
                    	gd = nestedGd;
